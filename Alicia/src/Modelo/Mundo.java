...
public class Mundo {
	...
	public void agregar(Personaje alicia,Personaje nacho,Personaje pancho) {
		this.losPersonajes.add(alicia);
		this.losPersonajes.add(nacho);
		this.losPersonajes.add(pancho);
	}
	
	public Mundo(ArrayList losPersonajes) {
